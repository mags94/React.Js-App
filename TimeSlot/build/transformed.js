...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_dom__ = __webpack_require__(16);
...
class Details extends React.Component {
  ...
  onSubmit(event) {
    ...
    localStorage.setItem(this.props.location.state.name, "red");
  }
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('input', { type: 'text', name: 'fname', value: this.state.fname, required: true, onChange: this.onChangeHandler.bind(this) }),
        ...
        React.createElement('input', { type: 'text', name: 'lname', value: this.state.lname, required: true, onChange: this.onChangeHandler.bind(this) }),
        React.createElement('br', null),
        React.createElement('br', null),
        React.createElement(
          'label',
        ...
        React.createElement('input', { type: 'text', name: 'phoneNum', value: this.state.phoneNum, required: true, onChange: this.onChangeHandler.bind(this) }),
        React.createElement('br', null),
        React.createElement('br', null),
        React.createElement(
          ...
          React.createElement(
            'button',
            { type: 'submit', style: { marginRight: '7px' }, onClick: this.onSubmit.bind(this) },
            'Submit'
          )
        ),
        React.createElement(
          ...
          React.createElement(
            'button',
            { type: 'submit', style: { display: 'inline-block', marginRight: '-59px' } },
            'Cancel'
          )
        )
      )
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Details__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_router_dom__ = __webpack_require__(16);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(15);
var Timeslot = __webpack_require__(48).default;



ReactDOM.render(React.createElement(Timeslot, null), document.getElementById('app'));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Details_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_router_dom__ = __webpack_require__(16);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(15);
...
class Timeslot extends React.Component {
  constructor(props) {
    super(props);
    if (localStorage.getItem("first1")) {
      this.state = {
        bgcolor1: JSON.parse(localStorage.getItem("first1"))
  ...
  // changeColor(event){
  //   if(!this.state.color_white){
  //     this.setState({color_white: false})
  //     console.log(this.state.color_white);
  ...
  //    }
  //     event.target.style.backgroundColor = this.state.color_white ? "white":"red" ;
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            { to: { pathname: '/details', state: { foo: 'one', name: 'first1' } } },
            React.createElement('div', { name: 'first1', style: { width: '60px', height: '60px', border: '2px solid black', marginTop: '100px', marginRight: '23px', display: 'inline-block', backgroundColor: { bgcolor1 } }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Two' } } },
            ' ',
            React.createElement('div', { name: 'second', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Three' } } },
            ' ',
            React.createElement('div', { name: 'third', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement('br', null),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Four' } } },
            React.createElement('div', { name: 'Fourth', style: { width: '60px', height: '60px', border: '2px solid black', marginTop: '30px', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Five' } } },
            React.createElement('div', { name: 'Fifth', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Six' } } },
            React.createElement('div', { name: 'Sixth', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement('br', null),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Seven' } } },
            React.createElement('div', { name: 'Seventh', style: { width: '60px', height: '60px', border: '2px solid black', marginTop: '30px', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Eight' } } },
            React.createElement('div', { name: 'eighth', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(
            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
            { to: { pathname: '/details', state: { foo: 'Nine' } } },
            React.createElement('div', { name: 'ninth', style: { width: '60px', height: '60px', border: '2px solid black', marginRight: '23px', display: 'inline-block' }, onClick: this.changeColor.bind(this) })
          ),
          React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { path: '/details', component: __WEBPACK_IMPORTED_MODULE_0__Details_js__["a" /* Details */] })
        )
      )
    );
  }
}
/* harmony export (immutable) */ __webpack_exports__["default"] = Timeslot;
